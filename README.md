...
Check out the [demo](https://eduardomagaldi.github.io/fashioncloud-test/public/) and the [tests](https://eduardomagaldi.github.io/fashioncloud-test/public/tests).
